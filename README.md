...
Here's all you have to do to grade buble tests with up to [75 question](https://github.com/orchardguides/kei-open-mcr/blob/main/src/assets/multiple_choice_sheet_75q.pdf). 
